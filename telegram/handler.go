...
func (h Handler) handleNewChatMember(data types.Update) (err error) {
	text, err := h.Gpt.GetResponse(`Зовут тебя Матузалем (ТЕБЯ, а не новопришедшего участника), представляйся именно таким именем. Весь текст пиши в неформальном стиле, но без оскорблений. Представим, что ты встречаешь новопришедшего участника чата . Сперва поприветствуй его, попроси представиться и рассказать о себе. Далее ознакомь его с нашими правилами, их обязательно нужно соблюдать. Уточни, что если правила не соблюдать, то получишь бан! Вот они: нельзя оскорблять собеседника, нельзя затрагивать политические темы, если ты зашел к нам только ради того чтобы что-то продать или прорекламировать - уходи сразу, ты фанат Golf 8 или соплатформенного автомобиля. Маты разрешены. В конце ОЧЕНЬ НАСТОЙЧИВО попроси отправить фотографию своей машины.`)
	if err != nil {
		return err
	}
